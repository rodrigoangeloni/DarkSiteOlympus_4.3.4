...
CREATE TABLE `arena_log` (
  ...
  `winnerTeam` int(9) DEFAULT NULL,
  `looserTeam` int(9) DEFAULT NULL,
  `winnerRating` int(9) DEFAULT NULL,
  `winnerMMR` int(9) DEFAULT NULL,
  `looserRating` int(9) DEFAULT NULL,
  `looserMMR` int(9) DEFAULT NULL,
  `winpl1` varchar(65) COLLATE utf8mb4_unicode_ci,
  `winpl2` varchar(65) COLLATE utf8mb4_unicode_ci,
  `winpl3` varchar(65) COLLATE utf8mb4_unicode_ci,
  `winpl4` varchar(65) COLLATE utf8mb4_unicode_ci,
  `winpl5` varchar(65) COLLATE utf8mb4_unicode_ci,
  ...
  `loosepl1` varchar(65) COLLATE utf8mb4_unicode_ci,
  `loosepl2` varchar(65) COLLATE utf8mb4_unicode_ci,
  `loosepl3` varchar(65) COLLATE utf8mb4_unicode_ci,
  `loosepl4` varchar(65) COLLATE utf8mb4_unicode_ci,
  `loosepl5` varchar(65) COLLATE utf8mb4_unicode_ci,
  ...
  `winIP1` varchar(65) COLLATE utf8mb4_unicode_ci,
  `winIP2` varchar(65) COLLATE utf8mb4_unicode_ci,
  `winIP3` varchar(65) COLLATE utf8mb4_unicode_ci,
  `winIP4` varchar(65) COLLATE utf8mb4_unicode_ci,
  `winIP5` varchar(65) COLLATE utf8mb4_unicode_ci,
  `looseIP1` varchar(65) COLLATE utf8mb4_unicode_ci,
  `looseIP2` varchar(65) COLLATE utf8mb4_unicode_ci,
  `looseIP3` varchar(65) COLLATE utf8mb4_unicode_ci,
  `looseIP4` varchar(65) COLLATE utf8mb4_unicode_ci,
  `looseIP5` varchar(65) COLLATE utf8mb4_unicode_ci,
