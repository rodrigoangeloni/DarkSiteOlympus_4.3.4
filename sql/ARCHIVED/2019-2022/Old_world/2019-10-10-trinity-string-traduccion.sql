...
UPDATE `Olympus_string` SET `content_loc6` = "Conexiones activas: %u (MAX: %u) 
Conexiones en cola: %u (MAX: %u)", 
`content_loc7` = "Conexiones activas: %u (MAX: %u) 
Conexiones en cola: %u (MAX: %u)" WHERE `entry` = 12;

UPDATE `Olympus_string` SET `content_loc6` = "Tiempo de actividad del servidor: %s", 
`content_loc7` = "Tiempo de actividad del servidor: %s" WHERE `entry` = 13;

UPDATE `Olympus_string` SET `content_loc6` = "Jugadores en línea: %u (max: %u)", 
`content_loc7` = "Jugadores en línea: %u (max: %u)" WHERE `entry` = 60;

UPDATE `Olympus_string` SET `content_loc6` = "
